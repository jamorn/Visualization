...
(function(){
    ...
    var correctAnswers = [3,0,2,4,3,4,4,4,4,0];

    var quizQuestions  = [
        {
            type: "text",
            text: "ข้อใดคือจุดประสงค์ของการทำ Visualization",
            possibilities: [
                {
                    answer: "a.การทำกราฟให้สวย"
                },
                {
                    answer: "b.ใช้ในการสื่อสาร"
                },
                {
                    answer: "c.ใช้ในการวิเคราะห์ข้อมูลนอกเหนือจากค่าสถิติ"
                },
                {
                    answer: "d. ข้อb,c ถูก"
                },
        ...
        {
            type: "text",
            text: "ชุดข้อมูลจาก sensor อุณหภูมิ ที่มีการเก็บทุกๆ ชั่วโมง หากเราต้องการทำ Visualization ถึงแพทเทิร์นการเปลี่ยนแปลงอุณหภูมิในแต่ละชั่วโมง เราควรเลือก Visualize แบบใด",
            possibilities: [
                {
                    answer: "a.Line Chart"
                },
        ...
        {
            type: "text",
            text: "ระยะเวลาในการทำงานและที่ระดับเสียงเฉลี่ยเท่าไหร่ จะต้องให้จัดทำ”โครงการอนุรักษ์การได้ยิน”",
            possibilities: [
                {
                    answer: "a.Line Chart"
                },
        ...
        {
            type: "text",
            text: "Visualize แบบใดเหมาะสำหรับการดูความสัมพันธ์ระหว่าง 2 Numerical data",
            possibilities: [
                {
                    answer: "a.Line Chart"
                },
        ...
        {
            type: "text",
            text: "Visualize แบบใดที่นำเทคนิค Inter Quartile Range มาแสดงผล รวมถึงการแสดงผล outlier ที่คิดตามเทคนิค Inter Quartile Range",
            possibilities: [
                {
                    answer: "a.Line Chart"
                },
        ...
        {
            type: "text",
            text: "สิ่งใดที่ควรทำเมื่อทำ Visualization",
            possibilities: [
                {
                    answer: "a.วางแผนการสื่อสาร ว่า Visualization ต้องการสื่อสารเรื่องใด"
                },
                {
                    answer: "b.ตั้งสมมุติฐานล่วงหน้าว่าการทำ Visualization จะตอบเราได้เรื่องใด"
                },
                {
                    answer: "c.เลือก Visualization ให้เหมาะสมกับเป้าหมายการสื่อสาร และ ข้อมูล"
                },
                {
                    answer: "d.ข้อ b,c ถูก"
                },
                {
                    answer: "e.ถูกทุกข้อ "
                }
        ...
        {
            type: "text",
            text: "เหตุใดการ Visualization ช่วยในการวิเคราะห์ข้อมูล ",
            possibilities: [
                {
                    answer: "a.สามารถตอบสมมุติฐาน ได้อย่างรวดเร็ว"
                },
                {
                    answer: "b.ค่าสรุปทางสิถิติเพียงอย่างเดียว อาจจะไม่สามารถสรุปแพทเทิร์นของข้อมูลได้"
                },
                {
                    answer: "c.มองเห็น outlier ได้อย่างรวดเร็ว"
                },
                {
                    answer: "d.มองเห็นการกระตายตัวของข้อมูล"
                },
                {
                    answer: "e.ถูกทุกข้อ "
                }
        ...
        {
            type: "text",
            text: "ข้อใดไม่ใช้คุณสมบัติของ Matplotlib",
            possibilities: [
                {
                    answer: "a.ใช้สำหรับการแสดง Chart"
                },
                {
                    answer: "b.ใช้สำหรับการแสดง Interactive Chart"
                },
                {
                    answer: "c.ใช้สำหรับการแสดง Animation Chart"
                },
                {
                    answer: "d.เรียก API ผ่าน Pandas ได้"
                },
                {
                    answer: "e.ใช้ aggregate data ได้"
                }
            ],
            selected: null,
            correct: null
        ...
        {
            type: "text",
            text: "ข้อใดคือส่วนประกอบของ Chart ใน Matplotlib",
            possibilities: [
                {
                    answer: "a.X-Y axis"
                },
                ...
                {
                    answer: "d.Major Tick/Minor Tick"
                },
                {
                    answer: "e.ถูกทุกข้อ"
                }
        ...
        {
            type: "text",
            text: "การเพิ่ม Title ใน matplotlib ต้องทำอย่างไร",
            possibilities: [
                {
                    answer: "a. plt.title(\"Title\")"
                },
                {
                    answer: "b. plt.legend(\"Title\")"
                },
                {
                    answer: "c. plt.xlabel(\"Title\")"
                },
                {
                    answer: "d. plt. ylabel(\"Title\")"
                },
                {
                    answer: "e.ไม่มีข้อใดถูกเลย"
                }
            ],
            selected: null,
            correct: null
